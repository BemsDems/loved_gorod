  ...
  Widget build(BuildContext context) {
    return BlocBuilder<IssuesBloc, IssuesState>(
      builder: (context, issuesState) {
        final currentIssue = issuesState.issues.firstWhere(
          (i) => i.id == issue.id,
          orElse: () => issue,
        );
        ...
        return BlocBuilder<AuthBloc, AuthState>(
          builder: (context, authState) {
            ...
            bool isVoted = userId != null && currentIssue.votesMap.containsKey(userId);
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: isVoted
                                          ? _buildVotedState()
                                          : _buildVoteButton(context, currentIssue.id, userId),
                                ),
                              ],
                            ),
                          ),
    ...
    return FilledButton(
      onPressed: userId == null ? null : () {
        context.read<IssuesBloc>().add(
          IssuesVoteRequested(issueId: issueId, userId: userId),
        );
      },
